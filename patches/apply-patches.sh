...
patch -p1 < ../../device/motorola/taido_row/patches/0016-frameworks_av_media.patch
cd ../..
cd frameworks/base
patch -p1 < ../../device/motorola/taido_row/patches/0014-add_procged_to_the_FD_whitelist.patch
cd ../..
